...
export default async function LandingPage() {
  ...
  return <main><SiteHeader user={user} />
    <section className="marketing-hero" style={{ backgroundImage: `linear-gradient(90deg,#050505 0%,rgba(5,5,5,.92) 34%,rgba(5,5,5,.12) 76%),linear-gradient(0deg,#050505 0%,transparent 38%),url('${basePath}/assets/photos/hero-fire-team.webp')` }}>
