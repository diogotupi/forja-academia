...
async function main(){
 ...
 const courses=[
  ...
  ["arquitetura-da-decisao","Arquitetura da Decisão","Clareza em cenários complexos","Um método para decidir com velocidade sem abrir mão da responsabilidade.","/liderflix/assets/banners/foco.png","Instituto 2630","Estratégia","Avançado",true,7900],
  ["codigo-da-presenca","O Código da Presença","Neurociência aplicada à liderança","Estado interno, comunicação e influência para líderes.","/liderflix/assets/banners/presenca.png","Freitas","Performance","Intermediário",true,7900],
  ["inteligencia-emocional","Inteligência Emocional Operacional","Controle antes da ação","Reconheça emoções, regule respostas e preserve a capacidade de decisão.","/liderflix/assets/banners/foco.png","Wallace","Comportamento","Fundamentos",true,6900],
  ["cultura-de-alta-performance","Cultura de Alta Performance","Do discurso ao comportamento","Ferramentas para criar padrões de excelência sustentáveis em equipes.","/liderflix/assets/banners/resiliencia.png","Instituto 2630","Cultura","Avançado",false,11900]
 ];
